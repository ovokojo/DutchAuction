...
export function BasicDutchAuction(): ReactElement {
    ...
    return (
        <div>
            ...
            <div>
                <StyledLabel>Seller Address: </StyledLabel>
                <StyledInput
                    type="text"
                    value={seller}
            ...
            <br></br>
            <div>
                <StyledLabel>Reserve Price (ETH): </StyledLabel>
                <StyledInput
                    type="text"
                    value={reservePrice}
            ...
            <br></br>
            <div>
                <StyledLabel>Offer Price Decrement (ETH): </StyledLabel>
                <StyledInput
                    type="text"
            ...
            <br></br>
            <div>
                <StyledLabel>Bid Amount (ETH): </StyledLabel>
                <StyledInput
                    type="text"
                    value={bidAmount}
